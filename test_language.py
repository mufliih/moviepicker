...
def test_language_scraping(genre, language):
    ...
    # IMDb Advanced Search URL with language parameter
    # Common parameter is 'languages' (e.g., languages=en) or 'primary_language'
    # Let's try 'languages' first as it's common in their advanced search
    url = f"https://www.imdb.com/search/title/?genres={genre}&languages={language}&sort=user_rating,desc&title_type=feature&num_votes=10000,"
    headers = {
